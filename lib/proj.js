...
jvm.Proj = {
   ...
   * @param c   {Number}  Central meridian in degrees
   */
   ...
   * @param x {Number}  X of point in Cartesian system as integer
   * @param y {Number}  Y of point in Cartesian system as integer
   * @param c {Number}  Central meridian in degrees
   */
