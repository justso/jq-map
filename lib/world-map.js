...
jvm.WorldMap.prototype = {
        ...
        var touchStartScale, touchStartDistance, map = this,
            ...
            if (touches.length == 1) {
                ...
                if (lastTouchesLength == 2) {
                    ...
                    map.setScale(
                    touchStartScale * scale, centerTouchX, centerTouchY)
                    map.label.hide();
                    e.preventDefault();
                } else {
     ...
     * @param {String|Array|Object} keys If <code>String</code> or <code>Array</code> the marker(s) with the corresponding code(s) will be selected.
     *  If <code>Object</code> was provided its keys are  codes of markers, state of which should be changed. Selected state will be set if value is true, removed otherwise.
     */
